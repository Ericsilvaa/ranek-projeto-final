<template>
  ...
  <section class="produtos-container">
    ...
    <!-- Produtos -->
    <!-- transition sempre vai no if || Quando se usa transition com elementos 
      de mesma tag tem q identificar, use o (key="") -->
